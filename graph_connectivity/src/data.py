...
class GraphConnectivityDataset(Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            dsu_mode: DSU union strategy (min, size, rank)
        """
        self.tokenizer = tokenizer
        self.max_n = max_n
        self.fixed = fixed
        self.dsu_mode = dsu_mode
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        comp_states = compute_dsu_states(shuffled, n, mode=self.dsu_mode)
