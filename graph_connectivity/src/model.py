...
def compute_losses(
    ...
    if isinstance(model, nn.DataParallel):
        answer_logits = model.module.classifier(ans_hidden)
    else:
    ...
    if probe is not None and lambda_state > 0:
        ...
        max_n = probe.module.max_n if isinstance(probe, nn.DataParallel) else probe.max_n
        ...
        for h in range(H):
            ...
            logits_flat = logits_h.reshape(-1, max_n)
